...
class SubmitCarViewModel : ViewModel() {
    ...
    /**
     * This method simply calls on the DatabaseSingleton method to send the info the the Database, the
     * parameters are all from the SubmitCarFragment
     *
    ...
    fun uploadInfo(
        ...
        DatabaseSingleton.sendInfo(context, yourInfo, carDetails, titleInfo, reservePrice, referral, imgBitmaps)
    }
}